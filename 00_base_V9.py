...
V9 - Fix errors from final testing
"""
...
# Function to check input is a valid currency amount
...
def collect_ingredients(number):
    ...
    for i in range(number):
        ...
        amount_purchased = 0
        while amount_purchased < amount_needed:
            amount_purchased = int_checker("How many grams of {} have you purchased: ".format(ingredient_name),
                                           ...
                                           "please enter the amount you have purchased")
            if amount_purchased < amount_needed:
                print("You have not purchased enough of the ingredient, "
                      "please purchased at least as much as the recipe requires")
